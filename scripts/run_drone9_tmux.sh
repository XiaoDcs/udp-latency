...
source "$AS2_SETUP"
export ROS_DOMAIN_ID="$ROS_DOMAIN_ID_VALUE"
./start_test.sh receiver --local-ip=192.168.104.109 --peer-ip=192.168.104.112 --enable-nexfi --nexfi-ip=192.168.104.9 --nexfi-device=mesh0 --time=2400 --enable-gps --drone-id=drone9 --gps-interval=0.1 --nexfi-interval=0.1 --enable-static-route --static-route-via=192.168.104.12
COMMAND
)
